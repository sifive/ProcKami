...
Require Import Kami.All.
    ...
    (* TODO All precise exceptions should be generated by the
            processor, not the memory *)
    ...
    Definition Memory_Page_Fault   := WO~1~1.
    ...
    (* Exceptions that are determined before decoding:
       ...
       Unsupported exceptions:
          ...
          5 Load Access Fault         ] b/c PMP checks are not supported
    ...
    *)
    ...
    Definition Exception_St_Addr_Misal   := WO~0~1~1~0.
    ...
    Definition Exception_St_Access_Fault := WO~0~1~1~1.
    Definition Exception_I_Page_Fault    := WO~1~1~0~0.
    Definition Exception_Ld_Page_Fault   := WO~1~1~0~1.
    Definition Exception_St_Page_Fault   := WO~1~1~1~1.
