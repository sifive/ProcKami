...
(* Decoder for RV64IMAC(FD) *)
    ...
    exact(
        ...
        LET funct3m2    <- instr $[ 14 : 13 ];        (* TODO : Get rid of these one-use? *)
        LET funct3m1    <- instr $[ 14 : 14 ];        (* TODO                             *)
        ...
        LET OP_IMM_ok   <- (#funct3l2 != $$ WO~0~1)   (* 0b?01 are the shift instructions *)
