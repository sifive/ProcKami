...
(* Decoder for RV64IMAC(FD) *)
    ...
    exact(
        ...
        LET not_ecall    <- #funct3_not0;              (* Note that ECALL and EBREAK share funct3       *)
        ...
        LET decoded      <- Switch #opcode Retn DInstKeys With {
                                ...
                                $$ Major_OP_IMM_32 ::= STRUCT {"imm"     ::= #i_imm              ;
                                                               ...
                                                               "rd?"     ::= $$ true             ;
                                                               "csr?"    ::= $$ false            };
                                $$ Major_OP_32     ::= STRUCT {"imm"     ::= #i_imm              ; (* OP : Note that imm doesn't matter here; [natToWord 64 0] would work just as well *)
                                                               "rs1?"    ::= $$ true             ;
                                                               "rs2?"    ::= $$ true             ;
                                                               "rd?"     ::= $$ true             ;
                                                               "csr?"    ::= $$ false            }
