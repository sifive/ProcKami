...
Definition model (xlen : list nat) : Mod := generate_model xlen supportedExts allow_misaligned Dlen_over_8 allow_inst_misaligned misaligned_access (_ 'h"1000") debug_buffer_sz.
